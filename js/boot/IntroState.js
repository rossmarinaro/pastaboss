...
////animations
	//pastafather idle anims
		this.anims.create({
			key: 'pastafather_blink_anims',
			frames:[
			{ key: 'pastafather_blinking_fr1' }, 
				{ key: 'pastafather_blinking_fr2' },
					{ key: 'pastafather_blinking_fr3' },
						{ key: 'pastafather_blinking_fr4' },
							{ key: 'pastafather_blinking_fr3' },
								{ key: 'pastafather_blinking_fr2' },
									{ key: 'pastafather_blinking_fr1', duration: 3000 }
	...
	this.anims.create({
		...
		//pastafather pulling out jar of spaghentity
		this.anims.create({
			key: 'pastafather_jar_anims',
			frames: [
				{key: 'hands_jar_fr1'},
					{key: 'hands_jar_fr2'},
						{key: 'hands_jar_fr3'},
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		this.pastafather = {
			body: this.add.sprite(400, 350, 'pastafather_blinking_fr1').play('pastafather_blink_anims', true).setAlpha(0),
		...
		this.plotText1 = {
			...
			block2: this.add.text(200, 100, "somewhere in the endless loop of time space...", {fill: '#ffff00', font: '25px Bangers'}).setStroke('#ff0000', 4).setShadow(2, 2, '#000000', true, false).setAlpha(0), 
		...
		////event 8
		function onEvent8(){
			 this.pastafather.hands.setTexture('hands_jar_fr1').play('pastafather_jar_anims');
			 this.time.addEvent({
				delay: 750,
				callback: onEvent9,
				callbackScope: this
