...
class PreloadState_MiniGame2 extends Phaser.Scene {
  constructor() {
    super("PreloadState_MiniGame2");
  }
...
////map, environment, and background
	...
	this.load.tilemapTiledJSON('miniGame2', 'assets/maps/miniGame2.json');
	this.load.image('miniGame2',  'assets/maps/miniGame2.png'); 
...
/////sound effects
  ...
  //////create/////// 
  create() {
	  this.scene.start('PlayState_MiniGame2');
