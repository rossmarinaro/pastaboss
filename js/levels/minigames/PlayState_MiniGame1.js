...
class PlayState_MiniGame1 extends Phaser.Scene {
  constructor() {
    super("PlayState_MiniGame1");
  }
...
create() {
	   ...
	   function onEvent(){
		...
		// load the map 
	    let miniGameMap1 = this.add.tilemap('miniGame1');
		...
		let backdropTiles = miniGameMap1.addTilesetImage('tiles4');
		let backdrop = miniGameMap1.createStaticLayer('bkgnd', backdropTiles, 0, 0);
		let backdropTiles2 = miniGameMap1.addTilesetImage('tiles2');
