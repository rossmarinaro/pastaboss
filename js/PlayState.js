...
////you win (collision with weed)
		...
		//this.cameras.main.setBackgroundColor('#5F127F'); 
...
//virtual buttons
		...
		//left button	
		this.leftButton =
		this.add.image(100, 900, 'left_button').setOrigin(0).setName('left_button').setInteractive(); 
		...
		// jump button
		this.jumpButton = 
		this.add.image(200, 900, 'jump_button').setOrigin(0).setName('jump_button').setInteractive();
		...
		// right button
		this.rightButton = 
		this.add.image(300, 900, 'right_button').setOrigin(0).setName('right_button').setInteractive();
		...
		this.A_button = 
		this.add.image(500, 900, 'A_button').setOrigin(0).setName('A_button').setInteractive();  
	...
	//// B button (macaroni weapon)
		this.B_button = 
		this.add.image(600, 900, 'B_button').setOrigin(0).setInteractive();
...
////virtual controls 
	//left
	if (this.leftButtonState === true && this.input.activePointer.isDown && cursors.left.isDown === false){	
			player.body.setVelocityX(-250);
			player.anims.play('walk', true);
			player.flipX = true;		
	}
  //jump
  if (this.jumpButtonState && this.input.activePointer.isDown && cursors.left.isDown === false && player.body.onFloor() === true){
			player.body.setVelocityY(-490);
			player.anims.play('fall', true);
  }
  //right
  if (this.rightButtonState && this.input.activePointer.isDown && cursors.left.isDown === false){
			player.body.setVelocityX(250);
			player.anims.play('walk', true);
			player.flipX = false;
  }
